  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
        <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-gray-100">Steps (Nodes)</h3>
              ...
              >
                <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-2">
                  <div>
                    ...
                    <p className="font-mono text-sm font-medium text-gray-900 dark:text-gray-100">{node.id}</p>
                  </div>
                  <div>
                    <span className="text-xs text-gray-500 dark:text-gray-400">Type:</span>
                    <p className="text-sm text-gray-700 dark:text-gray-300">{node.type}</p>
                  </div>
                  <div>
        ...
        {errors?.nodes && (
          <p className="text-sm text-red-600 dark:text-red-400 mt-2">{errors.nodes}</p>
        )}
      </div>

      {/* Edges Section */}
      <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
        <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Connections (Edges)</h3>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
        ...
        <div className="flex flex-wrap items-end justify-between gap-3 mb-4">
          <div className="flex items-center gap-2 flex-1 min-w-[200px]">
            ...
            <ArrowRightIcon className="h-5 w-5 text-gray-400 dark:text-gray-500 flex-shrink-0" />
            <div className="flex-1">
              <SingleSelect
            ...
            {definition.edges.map((edge, idx) => (
              ...
              >
                <div className="flex items-center gap-2">
                  <span className="font-mono text-sm bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 px-2 py-1 rounded">
                    {edge.from}
                  </span>
                  <ArrowRightIcon className="h-4 w-4 text-gray-400 dark:text-gray-500" />
                  <span className="font-mono text-sm bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 px-2 py-1 rounded">
                    {edge.to}
                  </span>
                </div>
                <Button
        ...
        {errors?.edges && (
          <p className="text-sm text-red-600 dark:text-red-400 mt-2">{errors.edges}</p>
        )}
      </div>
